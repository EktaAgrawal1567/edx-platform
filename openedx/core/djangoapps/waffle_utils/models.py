...
class CourseOverrideWaffleFlagModel(ConfigurationModel):
    ...
    def override_value(cls, waffle_flag, course_id):
        ...
        Arguments:
            ...
            course_id (ClourseLocator): The course id for which the flag may have
                been overridden.
        ...
        effective = cls.objects.filter(waffle_flag=waffle_flag, course_id=course_key).order_by('-change_date').first()
